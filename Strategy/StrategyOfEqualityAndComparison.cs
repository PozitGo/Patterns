...
namespace Strategy
{
    //IEquatable для реализации сортировки с помощью равенства и неравенства
    //IComparable реализация сортировки с помощью больше или меньше
    ...
    public class StrategyOfEqualityAndComparison
    {
